...
- 1.**左右绝对中外距**：利用绝对定位，左右两栏设置为绝对定位，中间设置对应方向大小的margin的值。
...
- 2.**Flex**：利用flex布局，左右两栏设置固定大小，中间一栏设置为flex:1。
...
- 3.**左右浮中放后**：利用浮动，左右两栏设置固定大小，并设置对应方向的浮动。中间一栏设置左右两个方向的margin值，注意这种方式**，中间一栏必须放到最后。
